...
static const Vcolor black = {0x00,0x00,0x00,0xff};

static const Vcolor white = {0xff,0xff,0xff,0xff};

static int quantizeWithOptions(Vbitmap *vbitmap, int maxcolors,
...
int quantize(Vbitmap *vbitmap, int maxcolors,
...
int getThemeColors(Vbitmap *vbitmap, int ncol, int *colors, int *scores)
{
 ...
 vcolors = (PVcolor)Ymem_malloc(ncol * sizeof(Vcolor));
