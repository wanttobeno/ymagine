...
int Ymagine_composeLine(unsigned char *srcdata, int srcbpp, int srcwidth,
...
int Ymagine_composeColor(Vbitmap *vbitmap, int color, ymagineCompose composeMode);
 ...
 * @return If succesfully unlocks the Vbitmap YMAGINE_OK, otherwise YMAGINE_ERROR
 */
int Ymagine_composeImage(Vbitmap *vbitmap, Vbitmap *overlay,
